...
echo '<title>JavaScript '.$row0['title'].'</title>' ;
        ...
        <div class="col-md-3">
            <form action="#" method="get">
                <div class="input-group">
                    ...
                    <input class="form-control" id="system-search" name="q" placeholder="İçerik Ara" required>
...
$bilgi=mysqli_query($con,"select * from kategori where ustKategori='$id'");
while($row=mysqli_fetch_assoc($bilgi)){
