...
$msjbaslik = $_POST['baslik'];
$msjicerik = $_POST['icerik'];
$aliciid = $_POST['msjalanid'];
$gonderenid = $_POST['msjgonderenid'];

$msjtarih='1';

	$sqlm=("INSERT INTO mesajlar (msj_baslik,msj_icerik,msj_gonderen_id,msj_alan_id,msj_tarih) VALUES ('$msjbaslik','$msjicerik','$gonderenid','$aliciid','$msjtarih')");
    $islem=mysqli_query($con,$sqlm);						 
...
if($islem==0){
  ...
  <strong>Dikkat!</strong> Böyle bir üye bulunamadı...
</div>'; 
...
echo '<div class="alert alert-success alert-dismissible" role="alert">
  <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
  <strong>Tebrikler!</strong> Mesajnız Gönderildi...
</div>';
